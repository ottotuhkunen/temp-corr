...
const airports: Airport[] = [
    ...
    { icao: "EFHK", name: "HELSINKI‑VANTAA", elevationFt: 180, corrections: [{ name: "IAF 04L", feet: 2300 }, { name: "IAF 04R", feet: 3300 }, { name: "IAF 15/22R", feet: 2000 }, { name: "IAF 22L/33", feet: 3000 }] },
    { icao: "EFIV", name: "IVALO", elevationFt: 482, corrections: [{ name: "TMA SMAC", feet: 3600 }, { name: "CTR SMAC", feet: 3000 }] },
    { icao: "EFJO", name: "JOENSUU", elevationFt: 399, corrections: [{ name: "IAF", feet: 2900 }, { name: "IAF ILS X", feet: 4000 }, { name: "TMA SMAC", feet: 2500 }] },
    { icao: "EFJY", name: "JYVÄSKYLÄ", elevationFt: 460, corrections: [{ name: "IAF", feet: 2900 }, { name: "TMA SMAC", feet: 2500 }, { name: "CTR SMAC", feet: 2100 }] },
    { icao: "EFKE", name: "KEMI‑TORNIO", elevationFt: 62, corrections: [{ name: "TMA SMAC", feet: 2500 }] },
    { icao: "EFKT", name: "KITTILÄ", elevationFt: 645, corrections: [{ name: "TMA SMAC", feet: 3800 }, { name: "CTR SMAC", feet: 3100 }] },
    { icao: "EFKK", name: "KOKKOLA‑PIETARSAARI", elevationFt: 85, corrections: [{ name: "IAF", feet: 2400 }, { name: "TMA SMAC", feet: 2100 }] },
    { icao: "EFKU", name: "KUOPIO", elevationFt: 324, corrections: [{ name: "IAF", feet: 2700 }, { name: "TMA/CTR SMAC", feet: 2100 }, { name: "S05 SMAC", feet: 2700 }] },
    { icao: "EFKS", name: "KUUSAMO", elevationFt: 868, corrections: [{ name: "TMA/CTR SMAC", feet: 3000 }] },
    { icao: "EFMA", name: "MARIEHAMN", elevationFt: 18, corrections: [{ name: "IAF", feet: 2000 }, { name: "TMA SMAC", feet: 1900 }] },
    { icao: "EFOU", name: "OULU", elevationFt: 48, corrections: [{ name: "IAF", feet: 2300 }, { name: "TMA SMAC", feet: 2100 }, { name: "CTR SMAC", feet: 1800 }] },
    { icao: "EFPO", name: "PORI", elevationFt: 45, corrections: [{ name: "TMA SMAC", feet: 2200 }] },
    { icao: "EFRO", name: "ROVANIEMI", elevationFt: 643, corrections: [{ name: "IAF", feet: 2500 }, { name: "TMA/CTR SMAC", feet: 2400 }] },
    { icao: "EFTP", name: "TAMPERE‑PIRKKALA", elevationFt: 391, corrections: [{ name: "IAF", feet: 2700 }, { name: "TMA SMAC", feet: 2300 }, { name: "CTR SMAC", feet: 2000 }] },
    { icao: "EFTU", name: "TURKU", elevationFt: 162, corrections: [{ name: "TMA SMAC", feet: 2200 }] },
    { icao: "EFVA", name: "VAASA", elevationFt: 21, corrections: [{ name: "TMA SMAC", feet: 2300 }] },
];
...
type Airport = { icao: string; name: string; elevationFt: number; corrections: CorrectionPoint[] };
type CTCRow = { range: string; correctedFt: number; correctedM: number };

function icaoTempCorrection(publishedFt: number, elevationFt: number, tempC: number): number {
...
function buildCTCTable(publishedFt: number, elevationFt: number, mocFt = 1001): CTCRow[] {
        ...
        <div className="min-h-screen bg-gradient-to-br from-neutral-900 to-neutral-950 text-white p-8 font-sans">
            ...
            <div className="mb-6 space-y-4 text-sm text-gray-100">
                <div className="flex items-start border-l-4 border-yellow-400 bg-neutral-800/60 p-3 rounded-lg shadow">
                    ...
                    <p className="text-yellow-400 font-semibold">Vain simulaattorikäyttöön VATSIM-verkostossa.</p>
                </div>
                ...
                <div className="flex items-start border-l-4 border-blue-400 bg-neutral-800/60 p-3 rounded-lg shadow">
                    ...
                    <p className="text-gray-400">Lämpötilakorjausta sovelletaan, kun korjauksen arvo on yli 20% vaadittavasta minimiestevarasta.</p>
                </div>
                ...
                <div className="flex items-start border-l-4 border-cyan-400 bg-neutral-800/60 p-3 rounded-lg shadow">
                    ...
                    <p className="text-gray-400">Annettaessa valvontapalvelua IFR-lennolle, lennonjohtaja huolehtii minimiestevaran säilymisestä. Lennonjohtaja huomioi lämpötilan vaikutuksen aina, kun lämpötila lentopaikalla on alle 0°C.</p>
                </div>
                ...
                <div className="flex items-start border-l-4 border-green-400 bg-neutral-800/60 p-3 rounded-lg shadow">
                    ...
                    <p className="text-gray-400">Mikäli lennonjohtaja on huomioinut kylmän lämpötilan vaatiman korjauksen, sisältää annettu selvitys sanonnan <code className="text-green-400 text-xs">LÄMPÖTILAKORJAUS TEHTY / TEMPERATURE CORRECTED BY ATC</code>.</p>
                </div>
            </div>
                                ...
                                <div key={idx} className="mt-4">
                                    ...
                                    <table className="w-full text-sm mt-3 border border-slate-700">
                                        ...
                                        <tr className="text-center">
                                            <th colSpan={3} className="bg-blue-950 p-2">{corr.name} {corr.feet} ft</th>
                                        </tr>
                                        <tr className="text-left">
                                            <th className="text-right max-w-40 font-normal p-2 bg-blue-200 text-black border border-slate-700">Lentopaikan lämpötila °C</th>
                                            <th className="text-center font-normal p-2 bg-blue-200 text-black border border-slate-700">Alin selvityskorkeus <b>ft/QNH</b></th>
